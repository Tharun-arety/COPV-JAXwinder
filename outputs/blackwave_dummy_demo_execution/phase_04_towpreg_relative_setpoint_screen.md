# Towpreg Relative Setpoint Screen
...
## Inputs
- `material_name`: `DUMMY_CF_TOWPREG_12MM`
- `sample_point_count`: `320`

## Metrics
- `peak_required_friction_coefficient`: `0.14848113059997559`
- `friction_headroom`: `0.0015188694000244085`
- `max_nominal_layer_build`: `68.0`
- `max_discrete_layer_build`: `68.0`
...
- Detail: `{'headroom': 0.0015188694000244085}`
- `quantization_error_within_helical_warning`: `True`
- Detail: `{'rmse': 5.617333549722722e-16, 'warning_limit': 0.1}`
...
## Artifacts
- phase_04_towpreg_relative_setpoint_screen.json
- phase_04_towpreg_relative_setpoint_screen.md
