# Inspection and Digital Thread Scaffold
...
## Inputs
- `line_name`: `UNSPECIFIED_COPV_LINE`
...
- `discrete_plan_artifact`: `A:\FPP web App\Tailored_Projects\COPV_JAX_winder\outputs\production_phase_execution\phase_02_discrete_course_planning.json`
- `kinematics_artifact`: `A:\FPP web App\Tailored_Projects\COPV_JAX_winder\outputs\production_phase_execution\phase_03_machine_kinematic_demand_screen.json`
- `as_built_artifact`: `A:\FPP web App\Tailored_Projects\COPV_JAX_winder\outputs\production_phase_execution\phase_05_first_order_as_built_laminate_surrogate.json`
...
- Detail: `{'discrete_plan_artifact': 'A:\\FPP web App\\Tailored_Projects\\COPV_JAX_winder\\outputs\\production_phase_execution\\phase_02_discrete_course_planning.json', 'kinematics_artifact': 'A:\\FPP web App\\Tailored_Projects\\COPV_JAX_winder\\outputs\\production_phase_execution\\phase_03_machine_kinematic_demand_screen.json', 'as_built_artifact': 'A:\\FPP web App\\Tailored_Projects\\COPV_JAX_winder\\outputs\\production_phase_execution\\phase_05_first_order_as_built_laminate_surrogate.json'}`
...
## Artifacts
- phase_07_inspection_and_digital_thread_scaffold.json
- phase_07_inspection_and_digital_thread_scaffold.md
