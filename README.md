...
- Re-run the pressure verification at a higher load level where the baseline design exceeds `Hashin FI = 1.0`, then show the optimizer using AFP patches to bring it back below the limit.
